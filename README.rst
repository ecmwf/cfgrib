...
[<xarray.Dataset>
Dimensions:                 (heightAboveGroundLayer: 2, isobaricInhPa: 19, x: 93, y: 65)
Coordinates:
    ...
    surface                 int64 ...
  * isobaricInhPa           (isobaricInhPa) int64 1000 950 900 ... 200 150 100
    heightAboveGround       int64 ...
    level                   int64 ...
...
Data variables:
    ...
    r2                      (y, x) float32 ...
    pwat                    (y, x) float32 ...
    hlcy                    (heightAboveGroundLayer, y, x) float32 ..., <xarray.Dataset>
...
Data variables:
    ...
    v                        (pressureFromGroundLayer, y, x) float32 ..., <xarray.Dataset>
Dimensions:     (x: 93, y: 65)
Coordinates:
    time        datetime64[ns] ...
    step        timedelta64[ns] ...
